const questoesSimulado = [
    ...
    },
    {
      ...
      enunciadocatro: `Acerca do saneamento básico no Brasil, avalie as afirmações a seguir.`,
    ...
    },
    {
      ...
      enunciadocatro: `II. A parte Proporcional do controlador PID é implementada ao ajustar, proporcionalmente, a variável de controle à diferença entre a temperatura desejada e a temperatura atual.`,
    ...
    },
    {
      ...
      enunciadocatro: `I. Quando há diferentes caminhos possíveis entre uma origem e um destino, a rota selecionada é a que apresenta o menor número de conexões.`,
    ...
    },
    {
      ...
      enunciadocatro: `I. Um serviço de nuvem pública proporciona a redução de custos operacionais, pois é possível dimensionar a necessidade desses recursos com base na demanda, visto que há momentos em que a empresa precisa de mais recursos e há momentos em que ela precisa de menos recursos.`,
